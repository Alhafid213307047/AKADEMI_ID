...
class _HasilPageState extends State<HasilPage> {
  ...
  Future<Map<String, dynamic>> fetchData() async {
    ...
    // Reversing the order for the red box
    ...
    // Fetching totals from Firestore and ensuring they are integers
    final totals = [
      historyData['out'] ?? 0,
      historyData['me'] ?? 0,
      historyData['comp'] ?? 0,
    ...
    // Generating rank based on totals
